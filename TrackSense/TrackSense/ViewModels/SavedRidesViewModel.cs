...
public partial class SavedRidesViewModel : BaseViewModel
{
    ...
    public SavedRidesViewModel(BluetoothService btService, RideService rideService, IConnectivity connectivity)
    {
        Title = "Tracksense";
    ...
    async Task GoToDetailsAsync(CompletedRideSummary rideSummary)
    {
        ...
        try
        {
            if (await CheckInternetConnection())
            {
                ...
                await Shell.Current.GoToAsync($"{nameof(CompletedRideStatisticsPage)}", true,
